		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Producs",
									"targetURL": "#dwfioritrnglyg04-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dwfioritrnglyg04-display": {
								"semanticObject": "dwfioritrnglyg04",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dw.fiori.trng.lyg04",
									"url": sap.ui.require.toUrl("dw/fiori/trng/lyg04")
								}
							}
						}
					}
